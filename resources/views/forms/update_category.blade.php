            ...
            <div class="card mt-5">
                <div class="card-title p-2" style="background: #97ADBD">
                    <div class="d-flex justify-content-between">
                        <h5 class="text-white mt-2 mx-2">Update Category</h5>
                ...
                <form method="POST" action="{{ route('category.update', $category->id) }}" id="updateCategoryModalForm">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="col-lg-12 p-3">
                                <div class="mb-3">
                                    <label for="name" class="form-label mt-3 mb-0"><strong>Category
                                            name</strong></label>
                                    <input type="text" class="form-control mt-2" name="cname" value="{{ $category->cname }}" required>
                                    @error('cname')
